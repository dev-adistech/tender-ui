...
import { FrmMastService } from '../../../Service/Config/frm-mast.service';
...
export class ViewParaMastComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.PER = await this._FrmOpePer.UserFrmOpePer('ViewParaMastComponent')
    ...
    if (eve.event.target !== undefined) {
      ...
      if (actionType == 'DeleteData') {
        ...
        this.FORMNAME = eve.data.FORMNAME ? eve.data.FORMNAME : '',
          ...
          this.FONTCOLOR = eve.data.FONTCOLOR ? eve.data.FONTCOLOR : '',
